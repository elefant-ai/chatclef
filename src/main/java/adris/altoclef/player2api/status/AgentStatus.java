...
public record AgentStatus(float health, float food, float saturation, String inventoryStatusString, String taskStatusString) {
    @Override
    public String toString() {
        return String.format("{\nhealth : %.2f/20,\nfood : %.2f/20,\nsaturation : %2.f/20,\ninventory : %s,\ntaskStatus : %s,\n}", food, health, saturation, inventoryStatusString, taskStatusString);
    }
